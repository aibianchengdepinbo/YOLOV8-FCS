...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='ultralytics/models/MTDT5C/yolov8-dyhead-ema-3.yaml', help='model.yaml path')
    ...
    parser.add_argument('--data', type=str, default='ultralytics/datasets/EL_ALL.yaml', help='data yaml path')
    ...
    parser.add_argument('--name', type=str, default='EL_ALL-yolov8-dyhead-ema-3_no_pre', help='save to project/name')
