...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='runs/train/MTDT5C/yolov6s-update/weights/best.pt', help='training model path')
    parser.add_argument('--data', type=str, default='ultralytics/datasets/MTDT5C.yaml', help='data yaml path')
    ...
    parser.add_argument('--name', type=str, default='MTDT5C-yolov6s-update', help='experiment name (project/name)')
