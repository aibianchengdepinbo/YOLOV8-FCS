...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='runs/train/MG/yolov8n/weights/best.pt', help='training model path')
    parser.add_argument('--source', type=str, default='D:/MG/all-images', help='source directory for images or videos')
    parser.add_argument('--conf', type=float, default=0.20, help='object confidence threshold for detection')
    ...
    parser.add_argument('--project', type=str, default='runs/detect/test', help='project name')
    parser.add_argument('--name', type=str, default='MG', help='experiment name (project/name)')
    parser.add_argument('--show', action="store_true",default=False, help='show results if possible')
    ...
    parser.add_argument('--line_width', type=int, default=4, help='line width of the bounding boxes')
