...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        # a_dict = {'crazing': 'Cr', 'inclusion': 'In', 'patches': 'Pa', 'pitted_surface': 'Ps', 'rolled-in_scale': 'Rs',
        #           'scratches': 'Sc'}
        # label = a_dict[label1]
        label=label.replace("crazing",
                            "Cr").replace("inclusion",
                                          "In").replace("patches",
                                                        "Pa").replace("pitted_surface",
                                                                      "Ps").replace("rolled-in_scale",
                                                                                    "Rs").replace("scratches",
                                                                                                  "Sc")
        # label=label.replace("Crease",
        #                     "Cr").replace("Crescent_gap",
        #                                   "Cg").replace("Inclusion",
        #                                                 "In").replace("Oil_spot",
        #                                                               "Os").replace("Punching",
        #                                                                             "Pu").replace("Rolled_pit",
        #                                                                                           "Rp").replace("Silk_spot",
        #                                                                                                         "Ss").replace("Waist_folding",
        #                                                                                                                       "Wf").replace("Water_spot",
        #                                                                                                                                     "Ws").replace("Welding_line",
        #                                                                                                                                                   "Wl")
        # label=label.replace("MT_Uneven","Un").replace("MT_Blowhole","Bl").replace("MT_Break","Br").replace("MT_Crack","Cr").replace("MT_Fray",
        #                                                                                                                             "Fr")
