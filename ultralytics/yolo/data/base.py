...
#-------------------------------------------------------------------rir start------------------------------
        ...
        # self.cv_resize_flags_with_weights = {cv2.INTER_NEAREST: 2,
        #                                      cv2.INTER_LINEAR: 2,
        #                                      cv2.INTER_CUBIC: 1,
        #                                      cv2.INTER_AREA: 1,
        #                                      cv2.INTER_LANCZOS4: 0.5,
        #                                      cv2.INTER_LINEAR_EXACT: 1,
        #                                      }
        # print()
# -------------------------------------------------------------------rir end------------------------------
            ...
            if r != 1:  # if sizes are not equal
                ...
                if self.use_rir:
                    if self.val_flag:
                        ...
                        interp = random_interpolation_resize(cv_resize_flags_with_weights=self.cv_resize_flags_with_weights)
                        # print("use_rir={},val_flag={}".format({self.use_rir}, {self.val_flag}))
                # ----------------------------------------------------rir end------------------------------------------
                else:
                    interp = cv2.INTER_LINEAR if (self.augment or r > 1) else cv2.INTER_AREA
